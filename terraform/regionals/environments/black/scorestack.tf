...
resource "aws_instance" "scorestack" {
  ...
  private_ip                  = cidrhost(local.vpn_ipv4_cidr_range, 200) # 10.255.254.200

  ipv6_addresses = [
    cidrhost(local.vpn_ipv6_cidr_range, 1229782938247303441) # "2600:1f26:1d:8000:1111:1111:1111:1111"
  ]
