...
$aclExtendValues = 'Ext-User-Force-Change-Password', 'Ext-Self-Self-Membership', 'Ext-Write-Self-Membership', 'Ext-ManageCA', 'Ext-Write-Member'
...
$aclExtendedValueRightGUID = @{
    ...
    "Ext-Write-Member"               = @("WriteProperty","bf9679c0-0de6-11d0-a285-00aa003049e2")
}
